...
class LogReader {
    ...
    processLogEntries(params, done) {
        ...
        // console.log('processLogEntries---->', batchState);
    ...
    _processReadRecords(params, batchState, done) {
        if (this._openLog) {
            ...
            // console.log('_processReadRecords - tailable cursor--->', batchState);
            return done();
        }
        ...
        return this.logConsumer.readRecords(readOptions, (err, res) => {
            ...
            // console.log('_processReadRecords--->', batchState);
            return done();
        });
    }
    ...
    _processPrepareEntries(batchState, done) {
        ...
        if (logRes.info && logRes.info.start === null) {
            // console.log('_processPrepareEntries - start null-->', logRes, batchState);
            return done(null);
        }
        ...
        // console.log('_processPrepareEntries---->', logRes, batchState);
        return undefined;
    }
    ...
    _processPublishEntries(batchState, done) {
        ...
        // for raft log only
        if (logRes.info && logRes.info.start === null) {
            // console.log('_processPublishEntries - start null--->', logRes, batchState);
            return done();
        }
        ...
        return async.each(Object.keys(entriesToPublish), (topic, done) => {
            ...
            if (err) {
                // console.log('_processPublishEntries - error---->', logRes, batchState);
                return done(err);
            }
            ...
            // console.log('_processPublishEntries----->', logRes, batchState);
            return done();
        });
    }
